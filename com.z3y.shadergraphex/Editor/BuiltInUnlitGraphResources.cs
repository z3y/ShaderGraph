...
{
    static class BuiltInUnlitGraphResources
    {
        public static string s_ResourceClassName => typeof(BuiltInUnlitGraphResources).FullName;

        public static string s_AssemblyName => typeof(BuiltInUnlitGraphResources).Assembly.FullName.ToString();
